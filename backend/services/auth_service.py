...
def get_current_user(
    ...
    # NEW. A revoked account's existing token must stop working immediately,
    # not just at their next login - otherwise an already-logged-in user
    # keeps full access for up to 24h (ACCESS_TOKEN_EXPIRE_MINUTES) after
    # being revoked. Checked here so it applies to every protected route.
